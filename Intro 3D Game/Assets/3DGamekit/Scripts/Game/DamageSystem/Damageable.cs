...
namespace Gamekit3D
{
    public partial class Damageable : MonoBehaviour
    {
        ...
        public UnityEvent OnDeath, OnReceiveDamage, OnHitWhileInvulnerable, OnBecomeVulnerable, OnResetDamage, OnHealDamage;
        ...
        public void HealDamage(double regen)
        {
            currentHitPoints += regen;
